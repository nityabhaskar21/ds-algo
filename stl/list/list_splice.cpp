...
int main ()
{
    ...
    // splice(iterator, list_name, iterator_pos) : Transfer elements pointed by iterator_pos from list_name 
    //     at position pointed by iterator.
    // splice(iterator, list_name, itr_start, itr_end) : Transfer range specified by itr_start 
